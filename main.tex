...
{Module Lead}{April 2024 \textbf{--} Present}
\vspace{1pt}
\resumeItemListStart
\resumeItem{Leading a cross-functional team of 7 (2 Sr Devs, 3 Jr Devs, 2 QA) to build a greenfield, cloud-native application and API for real-time trade compliance checks, including denied party list screening and background monitoring with automated alerts}
\resumeItem{Spearheaded architecture design and AWS infrastructure planning for a SaaS solution, using services such as Cloudflare, LaunchDarkly (feature flags), and Datadog}
\resumeItem{Improved unit test coverage from 10\% to 60\% by implementing automated testing pipelines, linting rules, and enforcing quality gates in CI/CD}
\resumeItem{Drive strategic initiatives including roadmap planning, architecture reviews, team hiring (onboarded 4 engineers), and mentoring through weekly 1:1s and code reviews}
\resumeItem{Collaborate closely with Sales, Technical Managers, and Project Managers to align product direction with customer needs and market demands}
\resumeItemListEnd

\vspace{-10pt}
\resumeSubheading
{}{}
{Principal Software Engineer}{Nov 2022 \textbf{--} April 2024}
\vspace{1pt}
\resumeItemListStart
...
\small{\item{
              ...
              \resumeItem{Received scholarship for taking CCDSAP (Codechef Certified Data Structure and Algorithms Program) and achieved Foundation Level {\href{https://www.codechef.com/certificates/public/d2ef739}{\textcolor{blue}{CCDSAP certificate}}}, ranking in the top 5\% of students at the time}
