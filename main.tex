...
\small{\item{
              ...
              \textbf{Tools:}{ Kubernetes, Terraform, Ansible, Argo CD, Postman, Swagger, Prometheus, Grafana, Elasticsearch, Stripe, Kafka, Selenium, Docker, Supebase, Auth0, Keycloak, Okta, Cloudflare} \\ \vspace{3pt}
...
\resumeSubheading
{}{}
{\textbf{Security Analyst}}{Jun 2018 \textbf{--} Aug 2019}
\vspace{1pt}
\resumeItemListStart
\resumeItem{Performed vulnerability assessments using tools like Nessus, Metasploit, Burp Suite, and Splunk}
\resumeItem{Automated security incident creation workflows by integrating Splunk alerts with ServiceNow}
\resumeItem{Supported SIEM tuning and threat detection initiatives to enhance alert accuracy and reduce noise}
\resumeItem{Discovered and reported a critical RCE vulnerability in public facing online judge, allowing code execution and data exfiltration; led to immediate security patching}
\resumeItemListEnd
\resumeSubHeadingListEnd
